package com.fyndev.githubuser.provider
...
import com.fyndev.githubuser.database.DatabaseContract.AUTHORITY
...
class UserProvider : ContentProvider() {
    ...
    init {
        // content://com.fyndev.githubuser/user
        sUriMatcher.addURI(AUTHORITY, TABLE_NAME, USER)

        // content://com.fyndev.githubuser/user/id
